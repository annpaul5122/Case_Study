...
alter table USER_FAVORITE_ARTWORK add constraint PK_USER_FAVORITE_ARTWORK primary key(UserID,ArtworkID)
...
VALUES 
  ('ArtSpace', 'Contemporary art gallery showcasing works from emerging artists.', 'New York City', 1, '09:00:00'),
...
--2 updateArtwork()
update ARTWORK set  CreationDate='1890-07-01' where ArtworkID=7

--3 removeArtwork()
delete from ARTWORK where ArtworkID=7
